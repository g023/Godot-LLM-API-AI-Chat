...
func do_context(str_id):
	...
	var ai_memory_pre 	= int($"../../ScrollContainer_template/VBoxContainer_convo/VBoxContainer_assistant/HBoxContainer/TextEdit_ai_memory_pre".text)
	var ai_memory_post 	= int($"../../ScrollContainer_template/VBoxContainer_convo/VBoxContainer_assistant/HBoxContainer/TextEdit_ai_memory_post".text)
	var txt_assistant 	= ""
	var txt_prompt 		= ""
